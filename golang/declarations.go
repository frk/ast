...
func (d ConstDecl) Walk(w *ast.Writer) {
	if d.Doc != nil {
		d.Doc.Walk(w)
		w.Write("\n")
	}
...
func (d VarDecl) Walk(w *ast.Writer) {
	if d.Doc != nil {
		d.Doc.Walk(w)
		w.Write("\n")
	}
...
func (d TypeDecl) Walk(w *ast.Writer) {
	if d.Doc != nil {
		d.Doc.Walk(w)
		w.Write("\n")
	}
...
func (d FuncDecl) Walk(w *ast.Writer) {
	if d.Doc != nil {
		d.Doc.Walk(w)
		w.Write("\n")
	}
...
func (d MethodDecl) Walk(w *ast.Writer) {
	if d.Doc != nil {
		d.Doc.Walk(w)
		w.Write("\n")
	}
...
func (p RecvParam) Walk(w *ast.Writer) {
...
func (p PointerRecvType) Walk(w *ast.Writer) {
	w.Write("*")
	w.Write(p.Type)
}
